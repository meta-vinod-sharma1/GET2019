...
function empFormValidation() {
    ...
    if (password.length < 8) {
        ...
        var message = "password should be at least One Upper and One Lower case and one digit and should not have special characters";
        document.getElementById("epassword").innerHTML = message;
        flag = false;
    }else{
    ...
    if (flag == true) {
        //calling emp_details function with will hide employee form and show vehicle form
        emp_details();
    }
    return flag;
}
